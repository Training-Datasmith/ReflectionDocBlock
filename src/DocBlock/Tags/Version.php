 ...
 */
final class Version extends Base_Tag
{
    ...
    {
        Assert::null_or_string_not_empty($version);
    ...
    public static function create(?string $body, ?Description_Factory $description_factory = null, ?Type_Context $context = null): ?self
    {
        ...
        $description = null;
        if ($description_factory !== null) {
            $description = $description_factory->create($matches[2] ?? '', $context);
        }
